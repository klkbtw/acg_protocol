...
async def mines(ctx, round_id):
    ...
    if round_length < 36:
        ...
        pfp = 'https://cdn.discordapp.com/attachments/1020159817135956020/1020165696056999956/tumblr_md8bstdN5c1qdqx43.gif'
        em = discord.Embed(color=0x11F1D3)
        em.set_thumbnail(url=pfp)
        em.set_footer(text="miner bot")
        em.add_field(name="Mines predictor old",value=row1 + "\n" + row2 + "\n" + row3 + "\n" + row4 +"\n" + row5 + "\n" + "**Accuracy**" + "\n" + info +"%")
        await ctx.reply(embed=em)

bot.run("MTA2NjM0NjM4ODMwMjA4MjA4OA.GAWhhT.Ddfro5PI8ZJL64430hDAT2hD5_SA4K4i4_c8_8")